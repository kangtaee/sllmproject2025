...
| 파일명 | 설명 |
|:---|:---|
| `main.py` | FastAPI 서버 및 Phi-2 모델 서빙 스크립트 |
| `gemma2.html` | 사용자 입력창/답변창 UI 페이지 |
| `gemma2_js.js` | API 요청 및 응답 처리 JavaScript 파일 |
...
본 프로젝트를 통해 소형 LLM 기반의 텍스트 생성기 구현 전 과정을 실습할 수 있었고, 추론 최적화 및 서비스 적용 가능성을 평가할 수 있었다.  
Phi-2는 상대적으로 적은 연산 리소
